...
export function get_pk_file(): number;
export function get_vk_file(): number;
export function verify_proof(a: number, b: number, c: number, d: number, e: number): number;
export function generate_proof(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
...
export function compress_to_spartan(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function verify_spartan(a: number, b: number, c: number, d: number, e: number): number;
export function __wbgt_fold_3_test_0(a: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7349eef91e40c952(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h8932db997fb4011f(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke3_mut__h2980d311b0172268(a: number, b: number, c: number, d: number, e: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h2f24ac3ce8b9065a(a: number, b: number, c: number, d: number): void;
